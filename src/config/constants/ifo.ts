...
const ifos: Ifo[] = [
  {
    ...
    description:
      'Luckyswap is a decentralized exchange (DEX) protocol running on both Ethereum/Binance blockchain that allows traders to trade ERC-20 tokens directly from their wallets',
    launchDate: 'Mar. 10',
    launchTime: '5PM SGT',
    ...
    currency: 'Lucky LP',
    currencyAddress: '0x5a84e08ef780764aed1c391144aa2b07890dd271', //  LP token
    tokenDecimals: 18,
    tokenSymbol: 'BELT',
