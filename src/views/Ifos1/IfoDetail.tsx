      ...
      <BoxContent>
        <div className="two-column">
          ...
          <div className="two-column-right">
            <Dflex>
              <div>IDO Amount:</div>
              <div className="font-bold">4,000,000 HYFI</div>
            </Dflex>
            ...
            <Dflex>
              <div>Price:</div>
              <div className="font-bold">0.000575 BNB</div>
            </Dflex>

            <Dflex>
              <div>Start Block:</div>
              <div className="font-bold">6213225</div>
            </Dflex>

            <Dflex>
              <div>Time:</div>
              <div className="font-bold">Around 04.02 9:00 AM UTC</div>
            </Dflex>
          </div>
        </div>
      </BoxContent>
