...
const SidebarMobile = (props: SideBarProps) => {
  ...
  const onChangeRoute = () => {
    setMobileMenu(false)
    setTimeout(() => {
      history.push('/my-profile/onstore/readyToSell')
    }, 100)
  }
  return (
    <DrawerStyled
    ...
    >
      <SidebarStyled>
        <div className="button button-collapse">Collapse</div>
        <div className="button on-sale" onClick={onChangeRoute}>
        ...
        <div className="group-menu">
          ...
          <div
            className={true ? 'show-sub-menu list-sub-menu' : 'list-sub-menu'}
          >
            <Slider
              range
              step={100}
